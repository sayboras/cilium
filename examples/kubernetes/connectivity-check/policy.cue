...
deployment: "pod-to-external-fqdn-allow-google-cnp": _policyResource & _ipFamilyCheck & {
	_probeTarget: "www.google.com"
	_probePath:   ""
}
egressCNP: "pod-to-external-fqdn-allow-google-cnp": _policyResource & _ipFamilyCheck & {

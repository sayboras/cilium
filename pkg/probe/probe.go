...
func HaveFullLPM() bool {
	...
	if err = bpf.UpdateElement(m.GetFd(), unsafe.Pointer(&probeKey{}),
		unsafe.Pointer(&probeValue{}), bpf.BPF_ANY); err != nil {
		return false
	}
	if err = bpf.GetNextKey(m.GetFd(), nil, unsafe.Pointer(&probeKey{})); err != nil {
		return false
	}
	return true
}
